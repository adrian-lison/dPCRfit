...
that accounts for non-detects and concentration-dependent measurement error. You
can specify regression models via a simple formula like in the base R `lm`
function.
